...
function [DelaySeries, Fs, SampleDelays, FeatureNames] = getDelaySeriesFeatures( X, Fs, hopSize, skipSize, windowSize, NMFCCs )
	if nargin < 6
		NMFCCs = 13;
	end
    ...
    NAWindows = size(S, 2);
    S = S/NSpectrumSamples;%Normalize S
