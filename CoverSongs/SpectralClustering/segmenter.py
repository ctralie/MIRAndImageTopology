...
# MODIFIED: 2015-02-19 by Chris Tralie <chris.tralie@gmail.com>
# Main changes: Export the structure matrix for viewing outside of python
'''Music segmentation using timbre, pitch, repetition and time.

If run as a program, usage is:

    ./segmenter.py AUDIO.mp3 OUTPUT.mat
...
def lsd(X_rep, X_loc, beat_intervals, parameters):
    ...
    sio.savemat(parameters['output_file'], {'beat_intervals':beat_intervals, 'A_rep':A_rep, 'A_loc':A_loc, 'recurrence':recurrence, 'A_combined':A_combined})
