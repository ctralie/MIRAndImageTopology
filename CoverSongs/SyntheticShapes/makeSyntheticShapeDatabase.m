...
for kk = 1:NSongs
    ...
    bts = 0.5:0.5:0.5*length(PointClouds);
    save(sprintf('SyntheticData/%i.mat', kk), 'PointClouds', 'bts');
    PointClouds = PointClouds2;
    bts = 0.5:0.5:0.5*length(PointClouds);        
    save(sprintf('SyntheticData/%iCover.mat', kk), 'PointClouds', 'bts', 'corruptedIdx');   
end
